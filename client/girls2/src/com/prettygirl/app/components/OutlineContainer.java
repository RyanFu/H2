...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(ImageResourceUtils.dip2px(getContext(), 2));
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = (int) ImageResourceUtils.dip2px(getContext(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = (int) ImageResourceUtils.dip2px(getContext(), 5);
