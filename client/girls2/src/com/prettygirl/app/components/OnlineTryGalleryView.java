...
public class OnlineTryGalleryView extends JazzyViewPager {
    ...
    private int mType = BaseActivity.EXT_VALUE_ONLINE;

    public OnlineTryGalleryView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mActivity = (Activity) context;
    }

    public void init(int level, String baseUrl) {
        mGirlLoader = new GirlLoader(baseUrl, false);
        mLevel = level;
        ...
        MAX_PAGE_INDEX = Application.OFFLINE_BROWSER_MAX_PAGE_COUNT;
        ...
        mGirlLoader.forceAsyncLoadServerImageCount(getContext(), mLevel, new Runnable() {
            @Override
            public void run() {
                int count = mGirlLoader.getCachedTotalImageCount(getContext(), mLevel);
                ((TextView) mAdView.findViewById(R.id.txt)).setText(getContext().getString(R.string.try_online, count));
                mPagerAdapter.updateTotalImageCount(count);
    ...
    public long getTotalSize() {
    	return mPagerAdapter.mTotalPageCount;
    }
