...
public class AlertController {
    ...
    private boolean mReverseButton = false;
    ...
    public void installContent() {
        ...
        mWindow.setContentView(R.layout.dialog_alert_dialog);
        setupView();
    }
    ...
    private void setupView() {
        ...
        //        Object object = getStaticField("com.android.internal.R$styleable", "AlertDialog");
        TypedArray a = null;
        //        if (object != null) {
        //            a = mContext.obtainStyledAttributes(null, com.android.internal.R.styleable.AlertDialog,
    ...
    private boolean setupButtons() {
        final int mBitButtonPositive = 1;
        final int mBitButtonNegative = 2;
        final int mBitButtonNeutral = 4;
        int whichButtons = 0;
        mButtonPositive = (Button) mWindow.findViewById(mReverseButton ? R.id.button1 : R.id.button2);
        ...
        if (TextUtils.isEmpty(mButtonPositiveText)) {
            ...
            whichButtons = whichButtons | mBitButtonPositive;
        }

        mButtonNegative = (Button) mWindow.findViewById(mReverseButton ? R.id.button2 : R.id.button1);
        ...
        if (TextUtils.isEmpty(mButtonNegativeText)) {
            ...
            whichButtons = whichButtons | mBitButtonNegative;
        }
        ...
        if (TextUtils.isEmpty(mButtonNeutralText)) {
            ...
            View divider = mWindow.findViewById(R.id.view_divider2);
            divider.setVisibility(View.VISIBLE);

            whichButtons = whichButtons | mBitButtonNeutral;
        }
         ...
         */
        if (whichButtons == mBitButtonPositive) {
            centerButton(mButtonPositive);
        } else if (whichButtons == mBitButtonNegative) {
            centerButton(mButtonNeutral);
        } else if (whichButtons == mBitButtonNeutral) {
            centerButton(mButtonNeutral);
        }
    ...
    private void centerButton(Button button) {
        ...
        View divider = mWindow.findViewById(R.id.view_divider1);
    ...
    public static class AlertParams {
		...
		private void createListView(final AlertController dialog) {
            final RecycleListView listView = (RecycleListView) mInflater.inflate(R.layout.dialog_select_dialog, null);
            ListAdapter adapter;

            if (mIsMultiChoice) {
                if (mCursor == null) {
                    adapter = new ArrayAdapter<CharSequence>(mContext, R.layout.dialog_select_item_multi_choice,
                            R.id.text1, mItems) {
                        @Override
                    ...
                    adapter = new CursorAdapter(mContext, mCursor, false) {
                        ...
                        public View newView(Context context, Cursor cursor, ViewGroup parent) {
                            return mInflater.inflate(R.layout.dialog_select_item_multi_choice, parent, false);
                        }

                    };
                }
            } else {
                int layout = mIsSingleChoice ? R.layout.dialog_select_item_single_choice : R.layout.dialog_select_item;
                if (mCursor == null) {
