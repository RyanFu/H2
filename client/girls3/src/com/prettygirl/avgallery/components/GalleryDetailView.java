...
import com.prettygirl.avgallery.AvApplication;
import com.prettygirl.avgallery.ImageEditorActivity;
                ...
                ((CustomImageViewWithLoading) mViewCache[viewIndex]).setShareClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (obj != null && obj instanceof Integer) {
                            ...
                            File imageFile = new File(StorageUtils.getImageCacheDir(), AvApplication
